...
import { z } from "zod";
import { insertGarageServiceQuoteSchema } from "@shared/schema";
...
const formSchema = insertGarageServiceQuoteSchema.extend({
...
export default function GarageServiceQuoteForm() {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      businessType: "",
      numberOfLocations: "",
      repairServicesPercent: "",
      partsAccessoriesPercent: "",
      numberOfEmployees: "",
      annualGrossSales: "",
      status: "pending",
      payload: {},
  ...
  const submitMutation = useMutation({
    mutationFn: async (data: FormData) => {
      const response = await fetch("/api/garage-service-quotes", {
        method: "POST",
      ...
      <Card className="max-w-2xl mx-auto">
        <CardContent className="pt-6 text-center">
          ...
          <p className="text-muted-foreground">
            Thank you for your garage and service center insurance quote request. Our specialists will review your application and contact you within 24-48 hours with a comprehensive quote.
          </p>
        </CardContent>
      </Card>
    );
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-4xl mx-auto space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="ABC Auto Repair Inc." {...field} data-testid="input-applicant-name" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="contact@autorepair.com" {...field} data-testid="input-email" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Service center type and operational details</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="auto_repair">Automotive Repair Shop</SelectItem>
                        <SelectItem value="body_shop">Auto Body & Collision Repair</SelectItem>
                        <SelectItem value="parts_store">Parts & Accessories Store</SelectItem>
                        <SelectItem value="oil_change">Oil Change & Lubrication</SelectItem>
                        <SelectItem value="transmission">Transmission Repair</SelectItem>
                        <SelectItem value="glass">Automotive Glass Replacement</SelectItem>
                        <SelectItem value="truck_repair">General Truck Repair</SelectItem>
                        <SelectItem value="tire_shop">Tire Shop</SelectItem>
