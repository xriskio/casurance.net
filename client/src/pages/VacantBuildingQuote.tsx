...
export default function VacantBuildingQuote() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead
        title="Vacant Building Insurance Quote"
        description="Get insurance for vacant and unoccupied buildings. Protect empty properties from vandalism, fire, and liability claims."
        keywords="vacant building insurance, unoccupied property insurance, empty building coverage, vacant property insurance"
        canonical="/quote/vacant-building"
      />
      <Header />
