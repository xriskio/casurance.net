...
export const coverages: CoverageContent[] = [
...

  {
    ...
    whoNeeds: [
      ...
      "Renovation and remodeling contractors",
      "Commercial property owners during construction",
      "Building owners renovating existing structures"
    ],
    coverageIncludes: [
      "Ground-up construction: Up to $3.5M TIV for frame, $5M TIV for superior construction",
      "Renovation coverage: Up to $4M limits for Joisted Masonry or Masonry Non-Combustible",
      "Primary layers up to $2.5M for projects of $10M or less",
      "General liability limits up to $1M/$2M",
      "Excess builders risk options up to $5M",
      "Protection for materials, equipment, and structures during construction",
      "Coverage for theft, vandalism, and weather damage",
      "Existing building or structural coverage for renovations"
    ],
    benefits: [
      "Higher capacity for ground-up construction and renovations",
      "Coverage available in hard-to-insure locations (wildfires, severe weather)",
      "Flexible policy terms: 3, 6, 8, 10, or 12-month policies",
      "Prior starts considered for projects already underway",
      "Option to cover building materials only",
      "Delay in completion coverage available",
      "Business income and soft costs coverage",
...
export const industries: CoverageContent[] = [
  ...
  {
    title: "Auto Services with Garagekeepers",
    slug: "auto-services",
    category: "Industries",
    ...
    whoNeeds: [
      ...
      "Automotive oil change and lubrication centers (Quick Lube)",
      "Body shops and paint shops",
      "Construction and farm equipment service centers",
      "Dry-docked boat service operations",
      "Full-service car wash and car detailing businesses",
      "Gas stations with repair operations",
      "General automotive repair and service shops",
      "Heavy truck service facilities",
      "Mobile auto detailing services",
      "Mobile mechanic and roadside assistance operations",
      "Valet parking operations",
      "Light-duty and medium-duty auto repair shops",
    ...
    coverageIncludes: [
      "Full Garage Liability for non-dealer service & repair operations (occurrence basis)",
      "Garagekeepers Legal Liability: up to $300K per location, $100K per vehicle",
      "General Liability - Premises & Operations: $1M or $2M Aggregate",
      "Products & Completed Operations: $1M or $2M Aggregate",
      "Personal and Advertising Injury: $1M Occurrence",
      "Medical Payments: $5,000",
      "Fire Damage to Premises Rented to You: $100K to $1M",
      "Stop Gap Liability (ND, OH, WA, WY): $1M",
      "Limited Non-Owned Auto (on-premises customer autos only): $1M",
      "Employee Benefits Liability",
      "Up to $5M in excess coverage available (supported & unsupported)",
      "Building coverage: Max TIV $5M per location",
      "Business Personal Property",
      "Business Income with Extra Expense",
      "Tenant Improvements"
    ],
    benefits: [
      "Tech-enabled streamlined underwriting removes E&S friction",
      "Minimum premium starting at $1,500",
      "Deductibles starting at $500",
      "Separate deductibles for Covered Autos, Other Than Covered Autos, and Garagekeepers",
      "Maximum exposures up to $15M in sales, $3M in payroll",
      "Blanket Additional Insureds at $0 premium",
      "Scheduled Additional Insureds at $0 premium",
